...
while getopts ":a:b:s:u:p:e:" opt; do
    case $opt in
    a)
        __HOST=$OPTARG
        echo "__HOST: $__HOST"
...
__IPA_DOWNLOAD_URL_S="${__INSTALL_SSL}://${__CURRNET_BUILD_DOWN_PATH}/${__CURRNET_BUILD_APP_NAME}.ipa"
